        ...
        $('#tb_test_batch2').bootstrapTable({
            ...
            var a = "";
                ...
                formatter: function (value, row, index) {
                        ...
                        var c = '<a href="javascript:;" onclick="run_test_batch_record(\''+row.id+'\',\''+row.test_case_id+ '\')">删除</a> ';
                        var d = '<a href="javascript:;" onclick="run_test_batch_record(\''+row.id+'\',\''+row.test_case_id+ '\')">停止</a> ';
                        return b+a+c+d;
                        }
            }, {
                field: 'message',
